...
The first table you'd see in the output should be the **Model Information** table. You can use this table to confirm that the dependent variable is the "energy_action_n", "Poisson" is our probability distribution and we used the natural logarithm (i.e., "Log") as the link function. Clearly, if you are running a Poisson regression on your own data you'd have a different name for the dependent variable, but the probability distribution and link function should be the same!
