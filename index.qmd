...
For this lab, we shall be using the "autompg" dataset containing car information. This dataset provides data on fuel economy from 1999 and 2008 for about 38 popular models of cars. It contains a response variable known as "mpg," which records the city fuel efficiency of cars, alongside several predictor variables detailing the vehicle attributes. For anyone using R, you can find the dataset loaded with the *ggplot2* package.
